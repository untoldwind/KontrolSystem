...
namespace KontrolSystem.KSP.Runtime.Test {
    public class MockOrbitTests {
        ...
        public void TestShipOrbit() {
            ...
            AssertEqual(orbit.GetRelativePositionAtUT(2248030.02958346), new Vector3d(-16555.4669097162, -2375291.03194007, -984757.441721877));
            AssertEqual(orbit.GetOrbitalVelocityAtUT(2248030.02958346), new Vector3d(894.837941056022, 414.309011750899, 93.0483164395469));
        }

        [Fact]
        public void TestKerbinOrbit() {
            Assert.Equal(MockBody.Kerbin.orbit.GetTrueAnomalyAtUT(191234.147219217), -3.01263120009739, 7);
            AssertEqual(MockBody.Kerbin.orbit.GetRelativePositionAtUT(191234.147219217), new Vector3d(-13486907047.0309, -1748997796.87317, 0));
            AssertEqual(MockBody.Kerbin.orbit.GetOrbitalVelocityAtUT(191234.147219217), new Vector3d(1194.02661869056, -9207.40211722977, 0));
            AssertEqual(MockBody.Kerbin.orbit.GetRelativePositionAtUT(2248727.10958411), new Vector3d(-505812409.43674, -13590430780.3387, 0));
            AssertEqual(MockBody.Kerbin.orbit.GetOrbitalVelocityAtUT(2248727.10958411), new Vector3d(9278.07693080402, -345.314031847963, 0));
        }
