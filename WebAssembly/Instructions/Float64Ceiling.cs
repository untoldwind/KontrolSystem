...
namespace WebAssembly.Instructions {
    ...
    public class Float64Ceiling : ValueOneToOneCallInstruction {
        ...
        internal static readonly RegeneratingWeakReference<MethodInfo> Method =
            new RegeneratingWeakReference<MethodInfo>(() => typeof(Math).GetTypeInfo().DeclaredMethods.First(m => {
                if (m.Name != nameof(Math.Ceiling)) return false;
