...
#if NETCOREAPP3_0_OR_GREATER
    private static readonly MethodInfo leadingZeroCount =
 typeof(BitOperations).GetMethod(nameof(BitOperations.LeadingZeroCount), new[] { typeof(ulong) })!;
#endif
        ...
        context.Emit(OpCodes.Call, leadingZeroCount);
            ...
            context.Emit(OpCodes.Call, context[HelperMethod.Int64CountLeadingZeroes, (helper, c) => {
                var result = context.CheckedExportsBuilder.DefineMethod("☣ Int64CountLeadingZeroes",
                    CompilationContext.HelperMethodAttributes, typeof(ulong), new[] { typeof(ulong) });
