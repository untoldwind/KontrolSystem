...
#if NETCOREAPP3_0_OR_GREATER
    private static readonly MethodInfo rotateLeft =
 typeof(BitOperations).GetMethod(nameof(BitOperations.RotateLeft), new[] { typeof(ulong), typeof(int) })!;
#endif
        ...
        context.Emit(OpCodes.Call, rotateLeft);
            ...
            context.Emit(OpCodes.Call, context[HelperMethod.Int64RotateLeft, (helper, c) => {
                var builder = c.CheckedExportsBuilder.DefineMethod("☣ Int64RotateLeft",
