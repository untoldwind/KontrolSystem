...
namespace WebAssembly.Instructions {
    ...
    public class Float64Truncate : ValueOneToOneCallInstruction {
        ...
        internal static readonly RegeneratingWeakReference<MethodInfo> Method = new RegeneratingWeakReference<MethodInfo>(() => typeof(Math).GetTypeInfo()
            .DeclaredMethods.First(m => {
                if (m.Name != nameof(Math.Truncate)) return false;
