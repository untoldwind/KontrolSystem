...
namespace WebAssembly.Instructions {
    ...
    public class Float64CopySign : SimpleInstruction {
        ...
        internal sealed override void Compile(CompilationContext context) {
            context.PopStackNoReturn(OpCode.Float64CopySign, WebAssemblyValueType.Float64,
                WebAssemblyValueType.Float64);

            context.Emit(OpCodes.Call, context[HelperMethod.Float64CopySign, (helper, c) => {
                var builder = c.CheckedExportsBuilder.DefineMethod("☣ Float64CopySign",
                    CompilationContext.HelperMethodAttributes, typeof(double),
