...
namespace WebAssembly.Instructions {
 ...
 typeof(BitOperations).GetMethod(nameof(BitOperations.TrailingZeroCount), new[] { typeof(uint) })!;
#endif
        ...
        context.Emit(OpCodes.Call, trailingZeroCount);
            ...
            context.Emit(OpCodes.Call, context[HelperMethod.Int32CountTrailingZeroes, (helper, c) => {
                var result = context.CheckedExportsBuilder.DefineMethod("☣ Int32CountTrailingZeroes",
                    CompilationContext.HelperMethodAttributes, typeof(int), new[] { typeof(uint) });
