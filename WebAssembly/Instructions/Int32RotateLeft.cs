...
namespace WebAssembly.Instructions {
 ...
 typeof(BitOperations).GetMethod(nameof(BitOperations.RotateLeft), new[] { typeof(uint), typeof(int) })!;
#endif
        ...
        context.Emit(OpCodes.Call, rotateLeft);
            ...
            context.Emit(OpCodes.Call, context[HelperMethod.Int32RotateLeft, (helper, c) => {
                var builder = c.CheckedExportsBuilder.DefineMethod("☣ Int32RotateLeft",
