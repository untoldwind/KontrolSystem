...
namespace WebAssembly.Instructions {
    ...
    public class GlobalSet : VariableAccessInstruction {
        ...
        public GlobalSet(uint index) : base(index) {
        }

        internal GlobalSet(Reader reader) : base(reader) {
        }
        ...
        internal sealed override void Compile(CompilationContext context) {
            ...
            if (global.Setter == null) throw new CompilerException($"Global at index {this.Index} is immutable.");

            context.PopStackNoReturn(OpCode.GlobalSet, global.Type);

            if (global.RequiresInstance) context.EmitLoadThis();
