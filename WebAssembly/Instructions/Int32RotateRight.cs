...
namespace WebAssembly.Instructions {
 ...
 typeof(BitOperations).GetMethod(nameof(BitOperations.RotateRight), new[] { typeof(uint), typeof(int) })!;
#endif
        ...
        context.Emit(OpCodes.Call, rotateRight);
            ...
            context.Emit(OpCodes.Call, context[HelperMethod.Int32RotateRight, (helper, c) => {
                var builder = c.CheckedExportsBuilder.DefineMethod("☣ Int32RotateRight",
                    CompilationContext.HelperMethodAttributes, typeof(uint), new[] { typeof(uint), typeof(int), });
