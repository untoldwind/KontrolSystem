...
namespace WebAssembly.Instructions {
    ...
    public class BranchTable : Instruction, IEquatable<BranchTable> {
        ...
        public BranchTable(uint defaultLabel, params uint[] labels) : this(defaultLabel, (IList<uint>)labels) {
        }
        ...
        internal BranchTable(Reader reader) {
            ...
            for (var i = 0; i < count; i++) labels.Add(reader.ReadVarUInt32());
        ...
        internal sealed override void WriteTo(Writer writer) {
            ...
            foreach (var label in labels) writer.WriteVar(label);
        ...
        public bool Equals(BranchTable? other) =>
            other != null && other.DefaultLabel == this.DefaultLabel && other.Labels.Count == this.Labels.Count &&
        ...
        public override int GetHashCode() =>
            HashCode.Combine((int)this.OpCode, (int)this.DefaultLabel,
