...
#if NETCOREAPP3_0_OR_GREATER
    private static readonly MethodInfo trailingZeroCount =
 typeof(BitOperations).GetMethod(nameof(BitOperations.TrailingZeroCount), new[] { typeof(ulong) })!;
#endif
        ...
        context.Emit(OpCodes.Call, trailingZeroCount);
            ...
            context.Emit(OpCodes.Call, context[HelperMethod.Int64CountTrailingZeroes, (helper, c) => {
                var result = context.CheckedExportsBuilder.DefineMethod("☣ Int64CountTrailingZeroes",
                    CompilationContext.HelperMethodAttributes, typeof(long), new[] { typeof(ulong) });
