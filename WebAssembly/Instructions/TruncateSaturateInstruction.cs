...
namespace WebAssembly.Instructions {
    ...
    public abstract class TruncateSaturateInstruction : MiscellaneousInstruction {
        private protected TruncateSaturateInstruction() : base() {
        }
        ...
        internal sealed override void Compile(CompilationContext context) {
            ...
            context.Emit(OpCodes.Call, context[ConversionHelper, (helper, c) => {
                var builder = c.CheckedExportsBuilder.DefineMethod($"☣ {ConversionHelper}",
                    CompilationContext.HelperMethodAttributes, OutputType, new[] { InputType });
