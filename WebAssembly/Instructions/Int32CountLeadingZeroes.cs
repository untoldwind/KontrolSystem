...
namespace WebAssembly.Instructions {
 ...
 typeof(BitOperations).GetMethod(nameof(BitOperations.LeadingZeroCount), new[] { typeof(uint) })!;
#endif
        ...
        context.Emit(OpCodes.Call, leadingZeroCount);
            ...
            context.Emit(OpCodes.Call, context[HelperMethod.Int32CountLeadingZeroes, (helper, c) => {
                var result = context.CheckedExportsBuilder.DefineMethod("☣ Int32CountLeadingZeroes",
                    CompilationContext.HelperMethodAttributes, typeof(uint), new[] { typeof(uint) });
