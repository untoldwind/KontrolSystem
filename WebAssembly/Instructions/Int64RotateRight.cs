...
#if NETCOREAPP3_0_OR_GREATER
    private static readonly MethodInfo rotateRight =
 typeof(BitOperations).GetMethod(nameof(BitOperations.RotateRight), new[] { typeof(ulong), typeof(int) })!;
#endif
        ...
        context.Emit(OpCodes.Call, rotateRight);
            ...
            context.Emit(OpCodes.Call, context[HelperMethod.Int64RotateRight, (helper, c) => {
                var builder = c.CheckedExportsBuilder.DefineMethod("☣ Int64RotateRight",
                    CompilationContext.HelperMethodAttributes, typeof(ulong), new[] { typeof(ulong), typeof(long), });
