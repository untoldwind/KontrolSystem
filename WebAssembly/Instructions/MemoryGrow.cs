...
namespace WebAssembly.Instructions {
    ...
    public class MemoryGrow : Instruction {
        ...
        public override bool Equals(Instruction? other) =>
            other is MemoryGrow instruction && instruction.Reserved == this.Reserved;
        ...
        internal sealed override void Compile(CompilationContext context) {
            ...
            context.Emit(OpCodes.Call, context[HelperMethod.GrowMemory, (helper, c) => {
                var builder = c.CheckedExportsBuilder.DefineMethod("☣ GrowMemory",
                    CompilationContext.HelperMethodAttributes, typeof(uint), new[] {
                        typeof(uint), //Delta
