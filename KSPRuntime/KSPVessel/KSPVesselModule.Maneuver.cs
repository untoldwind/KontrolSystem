    ...
    public partial class KSPVesselModule {
        ...
        public class ManeuverAdapter {
            ...
            public Result<ManeuverNodeAdapter, string>
                ...
                if (!Double.IsFinite(ut) || !Double.IsFinite(radialOut) || !Double.IsFinite(normal) ||
                    !Double.IsFinite(prograde))
                    return Result.Err<ManeuverNodeAdapter, string>(
                        $"Parameter not finite ut={{ut}} radialOut={radialOut} normal={normal} prograde={prograde}");
