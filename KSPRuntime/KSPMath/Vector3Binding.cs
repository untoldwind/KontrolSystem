    ...
    public static class Vector3Binding {
        public static RecordStructType Vector3Type = new RecordStructType("ksp::math", "Vec3", "A 3-dimensional vector.", typeof(Vector3d),
            ...
            new Dictionary<string, IMethodInvokeFactory> {
                {"cross", new BoundMethodInvokeFactory("Calculate the cross/other product with `other` vector.", () => Vector3Type, () => new List<FunctionParameter> { new FunctionParameter("other", Vector3Type) }, false, typeof(Vector3d), typeof(Vector3d).GetMethod("Cross") )},
                {"dot", new BoundMethodInvokeFactory("Calculate the dot/inner product with `other` vector.", () => BuildinType.Float, () => new List<FunctionParameter> { new FunctionParameter("other", Vector3Type) }, false,typeof(Vector3d), typeof(Vector3d).GetMethod("Dot") )},
                {"angle_to", new BoundMethodInvokeFactory("Calculate the angle in degree to `other` vector.", () => BuildinType.Float, () => new List<FunctionParameter> { new FunctionParameter("other", Vector3Type) }, false, typeof(Vector3d), typeof(Vector3d).GetMethod("Angle") )},
                {"lerp_to", new BoundMethodInvokeFactory("Linear interpolate position between this and `other` vector, where `t = 0.0` is this and `t = 1.0` is `other`.", () => Vector3Type, () => new List<FunctionParameter> { new FunctionParameter("other", Vector3Type), new FunctionParameter("t", BuildinType.Float) }, false, typeof(Vector3d), typeof(Vector3d).GetMethod("Lerp") )},
                {"project_to", new BoundMethodInvokeFactory("Project this on `other` vector.", () => Vector3Type, () => new List<FunctionParameter> { new FunctionParameter("other", Vector3Type) }, false, typeof(Vector3d), typeof(Vector3d).GetMethod("Project") )},
                {"distance_to", new BoundMethodInvokeFactory("Calculate the distance between this and `other` vector.", () => Vector3Type, () => new List<FunctionParameter> { new FunctionParameter("other", Vector3Type) }, false, typeof(Vector3d), typeof(Vector3d).GetMethod("Distance") )},
                {"exclude_from", new BoundMethodInvokeFactory("Exclude this from `other` vector.", () => Vector3Type, () => new List<FunctionParameter> { new FunctionParameter("other", Vector3Type) }, false, typeof(Vector3d), typeof(Vector3d).GetMethod("Exclude") )},
                {"to_string", new BoundMethodInvokeFactory("Convert vector to string.", () => BuildinType.String, () => new List<FunctionParameter> { }, false, typeof(Vector3d), typeof(Vector3d).GetMethod("ToString", new Type[0]) )}
            },
