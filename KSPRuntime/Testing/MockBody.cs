...
namespace KontrolSystem.KSP.Runtime.Testing {
    public class MockBody : KSPOrbitModule.IBody {
        ...
        public static readonly MockBody Mun = new MockBody("Mun", 200000, Kerbin, 0, 0, 12000000, 0, 0, 0, 1.70000004768372,
        ...
        public static readonly MockBody Duna = new MockBody("Duna", 320000, Kerbol, 0.06, 0.051, 20726155264, 135.5, 0, 0,
        ...
        public static readonly MockBody Gilly = new MockBody("Gilly", 13000, Eve, 12, 0.550000011920929, 31500000, 80, 10, 0,
            0.899999976158142, 8289449.81471635, 126123.271704568, false, 0);

        public static readonly MockBody Jool = new MockBody("Jool", 6000000, Kerbol, 1.30400002002716, 0.0500000007450581,
            68773560320, 52, 0, 0, 0.100000001490116, 282528004209995, 2455985185.42347, true, 200000);

        public static readonly MockBody Tylo = new MockBody("Tylo", 600000, Jool, 0.025000000372529, 0, 68500000, 0, 0, 0,
            3.14000010490417, 2825280042099.95, 10856518.3683586, false, 0);

        public static readonly MockBody Laythe = new MockBody("Laythe", 500000, Jool, 0, 0, 27184000, 0, 0, 0, 3.14000010490417,
            1962000029236.08, 3723645.81113302, true, 50000);

        public static readonly MockBody Bop = new MockBody("Bop", 65000, Jool, 15, 0.234999999403954, 128500000, 10, 25, 0,
        ...
        public static readonly MockBody Vall = new MockBody("Vall", 300000, Jool, 0, 0, 43152000, 0, 0, 0, 0.899999976158142,
