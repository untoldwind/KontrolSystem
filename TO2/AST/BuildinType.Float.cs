        ...
        private class TO2Float : BuildinType {
            ...
            internal TO2Float() {
                allowedPrefixOperators = new OperatorCollection {
                    {
                        Operator.Neg,
                        new DirectOperatorEmitter(() => BuildinType.Unit, () => BuildinType.Float, OpCodes.Neg)
                    }, {
                        Operator.Add,
                        new DirectOperatorEmitter(() => BuildinType.Float, () => BuildinType.Float, OpCodes.Add)
                    }, {
                        Operator.Sub,
                        new DirectOperatorEmitter(() => BuildinType.Float, () => BuildinType.Float, OpCodes.Sub)
                    }, {
                        Operator.Mul,
                        new DirectOperatorEmitter(() => BuildinType.Float, () => BuildinType.Float, OpCodes.Mul)
                    }, {
                        Operator.Div,
                        new DirectOperatorEmitter(() => BuildinType.Float, () => BuildinType.Float, OpCodes.Div)
                    },
                };
                allowedSuffixOperators = new OperatorCollection {
                    {
                        ...
                        Operator.Eq,
                        new DirectOperatorEmitter(() => BuildinType.Float, () => BuildinType.Bool, OpCodes.Ceq)
                    }, {
                        Operator.NotEq,
                        new DirectOperatorEmitter(() => BuildinType.Float, () => BuildinType.Bool, OpCodes.Ceq,
                        ...
                        Operator.Gt,
                        new DirectOperatorEmitter(() => BuildinType.Float, () => BuildinType.Bool, OpCodes.Cgt)
                    }, {
                        Operator.Lt,
                        new DirectOperatorEmitter(() => BuildinType.Float, () => BuildinType.Bool, OpCodes.Clt)
                    }, {
                        Operator.Ge,
                        new DirectOperatorEmitter(() => BuildinType.Float, () => BuildinType.Bool, OpCodes.Clt,
                            OpCodes.Ldc_I4_0, OpCodes.Ceq)
                ...
                allowedMethods = new Dictionary<string, IMethodInvokeFactory> {
                    {
                        "to_string",
                        new BoundMethodInvokeFactory("Convert the float to string.", () => BuildinType.String,
                        ...
                        new BoundMethodInvokeFactory("Convert the float to string with fixed number of `decimals`.",
                            () => BuildinType.String,
                            () => new List<RealizedParameter>() {new RealizedParameter("decimals", BuildinType.Int)},
                ...
                allowedFields = new Dictionary<string, IFieldAccessFactory> {
                    {
                        ...
                        "abs",
                        new BoundPropertyLikeFieldAccessFactory("Absolute value", () => BuildinType.Float, typeof(Math),
            ...
            public override bool IsAssignableFrom(ModuleContext context, TO2Type otherType) =>
                otherType == BuildinType.Int || otherType == BuildinType.Float;

            public override IAssignEmitter AssignFrom(ModuleContext context, TO2Type otherType) =>
                otherType == BuildinType.Int ? intToFloatAssign : DefaultAssignEmitter.Instance;
        }
    }
}
