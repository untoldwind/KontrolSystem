...
namespace KontrolSystem.TO2.AST {
    public static class BuildinFunctions {
        ...
        private static readonly IKontrolFunction Cell = new CompiledKontrolFunction("Cell", "Wrap a value as cell",
            ...
            BuildinType.Cell, typeof(Cell).GetMethod("Create"));
        ...
        private static readonly IKontrolFunction ArrayBuilder = new CompiledKontrolFunction("ArrayBuilder",
            ...
            new List<RealizedParameter> {new RealizedParameter("capacity", BuildinType.Int, new IntDefaultValue(32))},
            BuildinType.ArrayBuilder, typeof(ArrayBuilder).GetMethod("Create"));
