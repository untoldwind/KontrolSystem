...
namespace KontrolSystem.TO2.AST {
    public class FieldAssign : Expression {
        ...
        public FieldAssign(Expression target, string fieldName, Operator op, Expression expression, Position start = new Position(), Position end = new Position()) : base(start, end) {
            this.target = target;
