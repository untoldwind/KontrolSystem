...
namespace KontrolSystem.TO2.Parser {
    ...
    public static class TO2ParserExpressions {
        ...
        public static readonly Parser<Expression> recordCreate = Delimited1(
                    Seq(identifier, Spacing0.Then(Char(':')).Then(Spacing0).Then(expression)),
                    commaDelimiter, "<expression>").
                Between(Char('(').Then(WhiteSpaces0), WhiteSpaces0.Then(Char(')'))).
                Map((nameExpressions, start, end) => new RecordCreate(nameExpressions, start, end));
        ...
        public static readonly Parser<Expression> resultErrCreate = expression.
        ...
        public static readonly Parser<Expression> range_create = Seq(
            Alt(literalInt, bracketTerm), Spacing0.Then(Tag("..")).Then(Opt(Char('.'))), Spacing0.Then(Alt(literalInt, bracketTerm))
        ...
        public static readonly Parser<Expression> variableAssigment = Seq(
