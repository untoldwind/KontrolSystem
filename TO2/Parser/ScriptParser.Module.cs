...
namespace KontrolSystem.TO2.Parser {
    ...
    public static class TO2ParserModule {
        ...
        ).Map((items, start, end) => new ConstDeclaration(items.Item2.IsDefined, items.Item3, items.Item1, items.Item4,
            items.Item5, start, end));
        ...
        public static readonly Parser<List<IModuleItem>> ModuleItems =
