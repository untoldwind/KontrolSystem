    ...
    public class Int64Extend32SignedTests {
        ...
        public void Int64Extend32Signed_Compiled() {
            var exports = ConversionTestBase<long, long>.CreateInstance(
                new LocalGet(0), new Int64Extend32Signed(), new End());
            ...
            Assert.Equal(65535, exports.Test(0xffff));
            Assert.Equal(0x7fffffff, exports.Test(0x7fffffff));
            Assert.Equal(-0x80000000, exports.Test(0x80000000));
            Assert.Equal(-1, exports.Test(0xffffffff));
            Assert.Equal(0, exports.Test(0x0123456700000000));
            Assert.Equal(-0x80000000, exports.Test(unchecked((long)0xfedcba9880000000)));
