    ...
    public class Int64CountTrailingZeroesTests {
        ...
        public void IInt64CountTrailingZeroes_Compiled() {
            var exports = CompilerTestBase<long>.CreateInstance(
                new LocalGet(0), new Int64CountTrailingZeroes(), new End());
            ...
            Assert.Equal(63, exports.Test(unchecked((long)0x8000000000000000)));
            Assert.Equal(0, exports.Test(0x7fffffffffffffff));
        }
    }
}
