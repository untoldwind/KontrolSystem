    ...
    public class Int64Load16UnsignedTests {
        ...
        public void Int64Load16Unsigned_Compiled_Offset0() {
            var compiled = MemoryReadTestBase<long>.CreateInstance(
                new LocalGet(), new Int64Load16Unsigned(), new End());
            ...
            using (compiled) {
                ...
                Assert.Equal(55357, exports.Test(8));
        ...
        public void Int64Load16Unsigned_Compiled_Offset1() {
            var compiled = MemoryReadTestBase<long>.CreateInstance(
                new LocalGet(), new Int64Load16Unsigned { Offset = 1, }, new End());
            ...
            using (compiled) {
                ...
                Assert.Equal(55357, exports.Test(7));
        ...
        public void Int64Load16Unsigned_Compiled_Then_Shift() {
            ...
            var compiled = MemoryReadTestBase<long>.CreateInstance(new LocalGet(),
                new Int64Load16Unsigned { Offset = off, }, new Int64Constant(shift), new Int64ShiftLeft(), new End());
