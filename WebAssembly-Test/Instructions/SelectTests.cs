...
namespace WebAssembly.Test.Instructions {
    ...
    public class SelectTests {
        ...
        public abstract class SelectTester<T> where T : struct {
            /// <summary>
            /// Tests the <see cref="Select"/> instruction.
            /// </summary>
        ...
        static Instance<SelectTester<T>> CreateTester<T>(WebAssemblyValueType type) where T : struct {
            var module = new Module();
            module.Types.Add(new WebAssemblyType {
                Parameters = new WebAssemblyValueType[] { type, type, WebAssemblyValueType.Int32, },
                Returns = new[] { type, },
            });
            module.Functions.Add(new Function { });
            module.Exports.Add(new Export { Name = nameof(SelectTester<T>.Test), });
            module.Codes.Add(new FunctionBody {
                Code = new Instruction[] {
                    new LocalGet(0), new LocalGet(1), new LocalGet(2), new Select(), new End(),
                },
            });
        ...
        public void Select_Compiled_Int32() {
            ...
            Assert.Equal(1, exports.Test(1, 2, 3));
            Assert.Equal(2, exports.Test(1, 2, 0));
            Assert.Equal(4, exports.Test(4, 5, 1));
            Assert.Equal(5, exports.Test(4, 5, 0));
        }
