...
namespace WebAssembly.Test.Instructions {
    ...
    public class GlobalGetTests {
        ...
        public void GetGlobal_Imported_Compiled() {
            ...
            var compiled = module.ToInstance<CompilerTestBase0<int>>(new ImportDictionary {
                { "Imported", "Global", new GlobalImport(() => ImportedImmutableGlobalReturns3) },
            });

            Assert.Equal(ImportedImmutableGlobalReturns3, compiled.Exports.Test());
        }
        ...
        public void GetGlobal_SecondExportFirstGlobal_Compiled() {
            ...
            Assert.Equal(5, exports.TestGlobal);
            Assert.Equal(5, exports.TestFunction());
        }
    }
}
